...
class CfnFlipTestCase(unittest.TestCase):
    def setUp(self):
        ...
        with open("{}/cfn_flip_examples/test.json".format(dir_path), "r") as f:
            self.input_json = f.read()

        with open("{}/cfn_flip_examples/test.yaml".format(dir_path), "r") as f:
            self.input_yaml = f.read()

        with open("{}/cfn_flip_examples/clean.json".format(dir_path), "r") as f:
            self.clean_json = f.read()

        with open("{}/cfn_flip_examples/clean.yaml".format(dir_path), "r") as f:
