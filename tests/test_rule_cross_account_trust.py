...
def test_resource_whitelisting_works_as_expected():
    ...
    processor.process_cf_template(template_two_roles, mock_config, result)
    ...
    assert result.failed_rules == [
        ...
        {
            "rule": "CrossAccountTrustRule",
            "reason": "RootRoleTwo has forbidden cross-account trust relationship with arn:aws:iam::999999999:role/someuser@bla.com",  # noqa
            "rule_mode": RuleMode.BLOCKING,
            "risk_value": RuleRisk.MEDIUM,
            "resource_ids": {"RootRoleTwo"},
            "actions": set(),
...
def test_whitelisted_stacks_do_not_report_anything():
    result = Result()
