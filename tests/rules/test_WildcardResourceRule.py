...
def test_multiple_resources_with_wildcard_resources_are_detected(user_and_policy_with_wildcard_resource):
    ...
    assert result.failures == [
        ...
        Failure(
            granularity="ACTION",
            reason='"RolePolicy" is using a wildcard resource in "TheExtremePolicy" for "dynamodb:DeleteGlobalTableWitness"',
            risk_value="MEDIUM",
            rule="WildcardResourceRule",
            rule_mode="BLOCKING",
            actions={
        ...
        Failure(
            granularity="ACTION",
            reason='"RolePolicy" is using a wildcard resource in "TheExtremePolicy" for "dynamodb:GetAbacStatus"',
            risk_value="MEDIUM",
            rule="WildcardResourceRule",
            rule_mode="BLOCKING",
            actions={
        ...
        Failure(
            granularity="ACTION",
            reason='"RolePolicy" is using a wildcard resource in "TheExtremePolicy" for "dynamodb:UpdateAbacStatus"',
            risk_value="MEDIUM",
            rule="WildcardResourceRule",
            rule_mode="BLOCKING",
            actions={
